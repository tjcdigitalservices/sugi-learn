...
This guide explains how to review Suguidanon during User Acceptance Testing (UAT). It focuses on what you can review and how to provide feedback — not technical implementation details.

---

## 1. Accessing the System

Suguidanon is a web application with two areas:
...
Contact your Suguidanon project team with:
