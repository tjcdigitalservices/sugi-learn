    ...
    <div className="researchers-page font-body">
      <header className="researchers-page__nav">
        <div className="researchers-page__nav-inner">
          ...
          >
            <Link href="/" className="researchers-page__nav-link">
              Home
            </Link>
            <Link href="/about" className="researchers-page__nav-link">
              About
            </Link>
            <Link
              href="/researchers"
              className="researchers-page__nav-link"
              aria-current="page"
            >
              Researchers
            </Link>
      ...
      <section className="researchers-roster" aria-label="Researcher portraits">
        <ul className="researchers-roster__list">
          {RESEARCHERS.map((researcher) => (
            <li key={researcher.name} className="researchers-roster__item">
